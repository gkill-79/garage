...
async function initialize() {
  ...
  db.Prestation = prestationModel(sequelize);
...
function prestationModel(sequelize) {
  const attributes = {
  ...
  return sequelize.define("Prestation", attributes);
}
...
function occasionModel(sequelize) {
  ...
  return sequelize.define("Occasion", attributes);
}
